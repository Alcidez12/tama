...
class SettingsController {
    ...
    async updateSetting(settingType, settingId, accountId, settingData) {
        let setting = await this.getSetting(settingType, settingId, accountId);
        if (setting) {
    ...
    async updateSubsetting(settingType, settingId, accountId, subType, subId, data) {
        let subsetting = await this.getSubsetting(settingType, settingId, accountId, subType, subId);
        if (subsetting) {
    ...
    async _createSubsetting(settingType, settingId, accountId, subType, subId, data) {
        let setting = new SubsettingModel({
            id: settingId,
            type: settingType,
            accountId,
            data,
